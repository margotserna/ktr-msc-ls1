                    ...
                    <div class="container">
                        ...
                        <form method="POST" action="{{ route('card.store') }}">
                            ...
                            <label for="name">Name</label>
                                <input id="name" name="name" type="string" class="form-control @error('name') is-invalid @else is-valid @enderror">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" name="email" type="email" class="form-control @error('email') is-invalid @else is-valid @enderror" required>
                            </div>
